...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_DEMANDE_TABLE = "CREATE TABLE " + TABLE_DEMANDE + "("
            ...
            " TEXT," + COLUMN_DATEDEM + " TEXT," + COLUMN_IDUSER + " INTEGER," /*+ TABLE_USER + "(" + COLUMN_USER_ID + ")" + ")"*/
            + " FOREIGN KEY ("+COLUMN_IDUSER+") REFERENCES "+TABLE_USER+"("+COLUMN_USER_ID+"));";
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                do {
                    ...
                    demandeAss.setPuissance(cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_PUISSACE)));
